...
<body>
    ...
    <p id="timeout-msg" style="color: red; display: none;">Puzzle is Invalid! Algorithm timed out after 10 seconds.</p>
    ...
    <div class="generator-section">
        ...
        <div class="difficulty-selector">
            ...
            <select id="difficulty">
                ...
                <option value="medium">Medium (35-40 clues)</option>
                <option value="hard">Hard (25-30 clues)</option>
                <option value="expert">Expert (17-24 clues)</option>
            </select>
        </div>
        <button type="button" id="generate">Generate Puzzle</button>
    </div>
